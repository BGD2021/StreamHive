...
BEGIN {
    ...
    require '/home/blueberry/code/rknn_usb_rtsp/lib/openssl-3.0.14/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/blueberry/code/rknn_usb_rtsp/lib/openssl-3.0.14/test/fips-and-base.cnf';
    shift;
